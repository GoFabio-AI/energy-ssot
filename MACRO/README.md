...
- [domestico-luce-boundary-vs-flussi.md](domestico-luce-boundary-vs-flussi.md)
...
| [domestico-luce-boundary-vs-flussi.md](domestico-luce-boundary-vs-flussi.md) | `README`, `INDEX`, `COMPLETION-PACKAGE`, `capability-map` e domini core del package domestico luce | chiarisce in modo esplicito cosa copre il baseline SSOT già chiuso e cosa invece appartiene al layer successivo di flussi, process architecture, BPMN, mapping SII profondo o handoff ERP-ready | non aggiunge nuovi fatti normativi; serve a evitare di confondere chiusura SSOT con completezza dei flussi implementativi |
